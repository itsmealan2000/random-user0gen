        ...
        <div style={{ backgroundColor: bgColor}} className='cover'>
          {userData ? (
            <div className='inner'>
              ...
              <div className='elemet'><strong className='rigthitems'>Company:     </strong>      {userData.company.address.address}<br /></div>              
              <div className='elemet'><strong className='rigthitems'>Job Title:   </strong>    {userData.company.title}<br /></div>              
              <div className='elemet' ><strong className='rigthitems'>Email:       </strong>        {userData.email}<br /></div>                            </div>
